...
class _PartyApplicationForElectionState extends State<PartyApplicationForElection> with SingleTickerProviderStateMixin {
  ...
  Future<void> _checkPartyStatus() async
  {
    ...
    )
    {
      ...
      if (existingData.exists)
      {
        ...
        (status == "Unreviewed")
        {
          message = "$status.\n\nParty '${widget.partyName}' not reviewed by election authorities.";
        ...
        (status == "Accepted")
        {
          message = "$status.\n\nParty '${widget.partyName}' is approved.";
        ...
        (status == "Rejected")
        {
          message = "$status.\n\nParty '${widget.partyName}' is not approved.";
