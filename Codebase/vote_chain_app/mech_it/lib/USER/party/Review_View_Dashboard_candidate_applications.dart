...
import 'package:mech_it/USER/party/Review_candidate_application.dart';
...
class ReviewCandidateApplication extends StatefulWidget {
  ...
  @override
  _ReviewCandidateApplicationState createState() => _ReviewCandidateApplicationState();
}

class _ReviewCandidateApplicationState extends State<ReviewCandidateApplication> with TickerProviderStateMixin
{
