...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void _fetchPartiesForState() async {
    if (_selectedState != null) {
      try
      {
        print('Fetching from path: /Vote Chain/Party/${_selectedState!}');
  ...
  void _login() async {
    ...
    try {
      ...
      if (user != null) {
        ...
        {
          if (_selectedRole == 'Citizen') { Navigator.pushReplacementNamed(context, '/CitizenHome');  }
          else if (_selectedRole == 'Candidate') { Navigator.pushReplacementNamed(context, '/CandidateHome');  }
          else if (_selectedRole == 'Party Head')
          {
          ...
          else if (_selectedRole == 'Admin') { Navigator.pushReplacementNamed(context, '/AdminDashboard');  }
        }
        else { ScaffoldMessenger.of(context).showSnackBar( SnackBar(content: Text('User does not exist or invalid details.')),  );   }
      }
    }
