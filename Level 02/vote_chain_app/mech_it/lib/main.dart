...
import 'USER/party/party_application_for_election.dart';
...
void main() async {
  ...
  await Firebase.initializeApp(
    options: FirebaseOptions(
      /// Replace below details using your firebase project...

        apiKey: '0000000000000000000000',  // From your config
        authDomain: '0000000000000',            // This should be retrieved from Firebase Console
        projectId: '00000000000000000000',
        storageBucket: '000000000000000',
        messagingSenderId: '00000000000000',               // Should be available in your Firebase Console
        appId: '0000000000000000000000000000000', // Should be available in your Firebase Console
