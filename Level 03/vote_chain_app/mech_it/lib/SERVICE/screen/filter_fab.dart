...
//     if
//     (   selectedType == "By-elections" || selectedType == "Referendum" || selectedType == "Confidence Motion (Floor Test)" )
//     {
...
//         ElevatedButton(
//           onPressed: () {
//             if (selectedYear.isEmpty || selectedType.isEmpty || selectedState.isEmpty ||  (selectedState != "_PAN India" && selectedConstituency.isEmpty) )
...
//////////////////   Above code doesn't have role based FAB........................

//////////////////   Below code does have role based FAB...........................
...
class _FilterDialogState extends State<FilterDialog> {
  ...
  Widget buildElectionTypeDropdown() {
    ...
    if (widget.role == 'Citizen') { validElectionTypes = AppConstants.electionTypes; }
    ...
    return AlertDialog(
      ...
      content: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            if(selectedType != 'Presidential' && selectedType != 'Vice-Presidential' && selectedState != "_PAN India" && widget.role != "Party_Head_View" )
            // Constituency Dropdown
              DropdownButtonFormField<String>
                (
                value: selectedConstituency.isNotEmpty ? selectedConstituency : null,
      ...
      actions: [
        ...
        ElevatedButton(
          onPressed: () {
            if
            (   selectedYear.isEmpty || selectedType.isEmpty || selectedState.isEmpty ||
                ( (widget.role != "Party_Head_View" || selectedState != "_PAN India" ) && selectedConstituency.isEmpty)  ||
