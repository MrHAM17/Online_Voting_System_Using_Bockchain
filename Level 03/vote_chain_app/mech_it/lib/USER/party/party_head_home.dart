...
import 'party_profile.dart'; // Import the correct screen
import 'review_candidate_applications.dart';
import 'party_application_approval_dashboard.dart';
...
class _PartyHeadHomeState extends State<PartyHeadHome> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Widget> tabs = [
      ...
      PartyApplicationForElection( partyName: selectedParty, ), // Tab 2: Apply for Elections
