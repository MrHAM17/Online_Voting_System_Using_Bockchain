      ...
      content: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            if (widget.role != 'Party Head' && widget.role != 'Party_Head_View' )
              DropdownButtonFormField<String>(
        ...
        ElevatedButton(
          onPressed: () {
            ...
            (   selectedYear.isEmpty || selectedType.isEmpty || selectedState.isEmpty ||
                ( (widget.role != "Party Head" || widget.role == 'Party_Head_View'  || widget.role != "Candidate" || selectedState != "_PAN India" ) && selectedConstituency.isEmpty)
