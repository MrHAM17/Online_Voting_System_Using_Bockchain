        ...
        if (partySnapshot != null && partySnapshot.exists) {
          ...
          if (partyData['isPartyApproved'] == 'YES') {
            ...
            if (selectedDoc.exists) {
              ...
              Map<String, dynamic> selectedData = selectedDoc.data() as Map<
                  String,
                  dynamic>;
              ...
              await FirebaseFirestore.instance
                  .doc('${partySnapshot.reference
                  .path}/$selectedConstituency/Selected') // Direct reference to the "Selected" document
            ...
            // Step 2:
            await FirebaseFirestore.instance.doc('$basePath/$candidateId')
                .update({'status': 'Accepted'});

            // Step 3:
            await FirebaseFirestore.instance.doc('${partySnapshot.reference
                .path}/$selectedConstituency/Selected').set(
            ...
            // .doc('Vote Chain/State/$selectedState/Election/$selectedYear/$selectedElectionType/Party_Candidate/${widget.partyName}/Selected_Candidates_Over_All_Constituency/$candidateId')
              ...
              // 'appliedConstituency': FieldValue.arrayUnion([selectedConstituency]),
              // does not make sense for here actually but will for candidate --> so store in detail for candidate in his profile...
              'selectedConstituency': FieldValue.arrayUnion(
            ...
            print("555555555555 Rendering ${candidateApplications
                .length} applications.");


            SnackbarUtils.showSuccessMessage(context,
                'Candidate selected for $selectedConstituency Constituency !');
          }
          else {
            SnackbarUtils.showErrorMessage(
                context, 'The party is not officially registered.');
      ...
      else if (currentStage == 6)
      {
        ...
        if (partySnapshot!.exists) {
          ...
          if (partyData['isPartyApproved'] == 'YES') {
            ...
            SnackbarUtils.showSuccessMessage(context,
                '${candidateData['name']} rejected for $selectedConstituency Constituency!');
          }
          else {
            SnackbarUtils.showErrorMessage(
                context, 'The party is not officially registered.');
