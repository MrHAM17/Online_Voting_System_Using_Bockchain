  ...
  Future<void> fetchOngoingElections() async {
    ...
    try {
      for (String electionType in AppConstants.electionTypes) {
        ...
        if (electionType == "General (Lok Sabha)" ||
            electionType == "Council of States (Rajya Sabha)") {
          adminPath =
          "Vote Chain/Election/$selectedYear/$electionType/State/${widget.state}/Admin/Election Activity/";
          fetchedResultPath =
          "Vote Chain/Election/$selectedYear/$electionType/State/${widget.state}/Result/Fetched_Result/";
        } else if (electionType == "State Assembly (Vidhan Sabha)" ||
            electionType == "Legislary Council (Vidhan Parishad)" ||
            electionType == "Municipal" ||
            electionType == "Panchayat") {
          adminPath =
          "Vote Chain/State/${widget.state}/Election/$selectedYear/$electionType/Admin/Election Activity/";
          fetchedResultPath =
          "Vote Chain/State/${widget.state}/Election/$selectedYear/$electionType/Result/Fetched_Result/";
        } else {
