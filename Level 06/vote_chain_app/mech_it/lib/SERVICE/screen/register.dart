...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  void _register() async {
    ...
    if
    (   _nameController.text.isEmpty || _selectedGender == null || _birthDateController.text.isEmpty  || _phoneController.text.isEmpty ||  _emailController.text.isEmpty ||
        ...
        (_selectedRole == 'Citizen' &&
            (_selectedEducation == null || _selectedEmployment == null || _selectedResidence == null ||
             _selectedLocSabhaConstituency == null || _selectedVidhanSabhaConstituency == null || _selectedVoterCategory == null || _selectedDisability == null
            )
        )
    ...
    {
      SnackbarUtils.showErrorMessage(context, "Please fill all the required fields");
      return;
    }
    ...
    try
    {
      ...
      if (user != null)
      {
        ...
        SnackbarUtils.showSuccessMessage(context, "Registration successful !");
        if
        (_selectedRole == 'Citizen')
        {
    ...
    catch (e)
    {
      ...
      SnackbarUtils.showErrorMessage(context, "Registration Failed: $e");
                      ...
                      child: _isGuestLoading
                          ...
                          : ElevatedButton(
                                ...
                                style: ElevatedButton.styleFrom(
                                  ...
                                  shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)),
                                  padding: EdgeInsets.symmetric(vertical: 16),
                                  primary: Colors.grey[100],  // 300 // Light gray color for guest button  // look better than below line
                                  // primary: Colors.white70, // Light gray color for guest button
                                ),
                              ),
                    ),
                  ],
