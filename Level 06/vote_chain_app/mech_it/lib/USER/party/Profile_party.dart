          ...
          return SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                _buildProfileCard('Total Members', partyData['totalMembers']?.toString() ?? 'N/A'),
                SizedBox(height: 24),
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            // Value right-aligned with horizontal scroll
            Expanded(
              flex: 2,
              child: Align(
                alignment: Alignment.centerRight,   // Right-aligned values
                child: SingleChildScrollView(
                  scrollDirection: Axis.horizontal,  // Enable horizontal scrolling for long values
                  child: Text(
                    value,
                    style: TextStyle(
                      fontSize: 18,
