...
// import 'USER/citizen/elections_reports.dart';
...
void main() async {
  ...
  await Firebase.initializeApp(
    options: FirebaseOptions(
      ...
      /// Replace with your firebase project details...
        ...
        apiKey: '0000000000000',  // From your config
        authDomain: '000000000000000000',            // This should be retrieved from Firebase Console
        projectId: '0000000000',
        storageBucket: '0000000000000000',
        messagingSenderId: '0000000000000',               // Should be available in your Firebase Console
        appId: '0000000000000000000', // Should be available in your Firebase Console
  ...
  String initialRoute = seenOnboarding ? '/Login' : '/Onboarding';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      // initialRoute: '/Onboarding', // not work properly -- always onboarding screen comes
